...
Flashed via serial by using TYWE3S pin. Might work with Tuya Convert.
...
I've configured some rules to get basic functionality. First rule string in Rule3 is required, otherwise your device might stop responding to serial commands.
...
```
*If you use the device buttons the state won't be recorded in Tasmota*
